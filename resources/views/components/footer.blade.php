    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex flex-col md:flex-row items-center gap-3">
                <div class="w-6 h-6 flex items-center justify-center shadow-sm">
                    <img src="{{ asset('images/logo.webp') }}" />
                </div>

                <div class="text-center md:text-left">
                    <div class="text-[10px] text-gray-700 font-bold tracking-tight">
                        &copy; {{ date('Y') }}
                        <span class="font-bold tracking-tight uppercase">
                            MS <span class="text-green-600">Smart Test</span>
                        </span>
                    </div>
                    <div class="text-[8px] text-gray-400 uppercase tracking-widest leading-tight">
            ...
            <div
                ...
                <div class="text-[8px] text-gray-400 uppercase tracking-widest mb-1">
                    Powered by
                </div>
